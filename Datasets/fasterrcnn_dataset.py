"""
Custom dataset class for the prostate and bladder detection. This is specifically for the FasterRCNN model.
    ...
    def get_targets(self, label_path, img_size, idx):
        ...
        with open(label_path) as f:
            ...
            for line in f:
                ...
                # +1 to class ID as FasterRCNN assumes background is 0.
